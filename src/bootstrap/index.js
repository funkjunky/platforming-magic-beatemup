...
import xbox1ControlsIndex from '../controls/mappings/xbox1';  // TODO: rename so it's consistent
...
export const replaceAllTheModules = () => {
  ...
  if (window.controlsInterval) {
    ...
    window.controlsInterval = setControls(xbox1ControlsIndex, window.store.dispatch);
  }
